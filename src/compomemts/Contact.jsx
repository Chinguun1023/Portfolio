...
const socialLinks = [
    ...
    {
        href: 'https://www.instagram.com/chingu_un',
    ...
    return (
        <section
            ...
            lg:items-stretch">
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        {
                            socialLinks.map(({ href, icon }, key) => (
                                <a
                                    ...
                                    className="w-12 h-1/2 grid
                                     place-items-center ring-inset ring-2
                                     ring-zinc-50/5 rounded-lg transition-
                ...
                <form
                    action="https://getform.io/f/bolmjmxa"
                    method="POST"
                    className="xl:grid md:items-center 
                md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            autoComplete="email"
                            required
                            placeholder="chingvvnet1212@gmail.com"
                            className="text-filed" />
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <textarea
                            ...
                            placeholder="Hi!"
                            required
                            className="text-filed resize-y min-h-32
                        max-h-80"
                        ></textarea>
                    </div>
